...
RUN wget https://raw.githubusercontent.com/proffesorx777/proffesorbot/master/probot.py
RUN wget https://raw.githubusercontent.com/proffesorx777/proffesorbot/master/requirements.txt
#RUN git clone https://github.com/proffesorx777/proffesorbot /root/userbot
#RUN mkdir /root/userbot/bin/
#WORKDIR /root/userbot/
#RUN chmod +x /usr/local/bin/*
RUN pip3 install -r requirements.txt
CMD ["python3","probot.py"]
