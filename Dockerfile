...
RUN wget https://raw.githubusercontent.com/B-Lac/B-Lac-Userbot/master/sh1vamrun.py
RUN wget https://raw.githubusercontent.com/B-Lac/B-Lac-Userbot/master/requirements.txt
